...
export function Footer() {
    ...
    return (
        <footer className='footer'>
            <div className='logo'>
                <img src="https://g-axon.com/wp-content/themes/twentysixteen-child/images/logo-footer.png" alt='gaxon logo'/>
                <div>
                    <QuestionCircleOutlined className={'svg'}/>
                    <span>
                <a href="https://preview.themeforest.net/item/wieldy-react-redux-ant-design-admin-template/full_screen_preview/22719616?_ga=2.51911081.1616364837.1656341266-1213331814.1645626464"
                   target="_blank"
                >
                    Raise Ticket
                </a>
